                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #4d5b76), color-stop(1, #6f80a1));">
							...
							</i> New', 'class="btn btn-danger btn-sm"'); ?> <button class="btn btn-tool" onclick="window.location.href='<?php echo site_url(); ?>/tbl_talent';"><i class="fas fa-redo-alt"></i></button></div>
                        </div>
                        <div class="card-body">
