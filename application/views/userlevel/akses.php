<div class="content-wrapper">
	<section class="content" style="padding-top: 1%">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<?php echo alert('alert-danger', 'Perhatian', 'Silahkan Cheklist Pada Menu Yang Akan Diberikan Akses') ?>
					<div class="card card-info">
						<div class="card-header">
							<h3 class="card-title">KELOLA HAK AKSES UNTUK LEVEL :  <b><?php echo $level['nama_level'] ?></b></h3>
						</div>
						<div class="card-body">
                        ...
                        <td align='center'><input type='checkbox' " . checked_akses( $this->uri->segment( 3 ), $m->id_menu ) . " onClick='kasi_akses($m->id_menu)'></td>
									...
									<tr>
              							<td></td>
              							<td><a href="<?php echo site_url('userlevel') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td>
            						</tr>
								</table>
							</div>
						</div>
