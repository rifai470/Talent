<div class="content-wrapper">
    <section class="content">
        	...
        	<div class="row">
            	<div class="col-12">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">KELOLA DATA TBL_USER</h3>
                    </div>
        ...
        <?php echo anchor(site_url('tbl_user/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?></div>
            </div>
            <div class='card-body'>
